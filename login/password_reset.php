    ...
    <div class="container mt-5">
        <div class="form-box mx-auto bg-light rounded-4 mb-3">
            <div class="px-4 py-2">
                ...
                <h2 class="text-center my-5">Password Reset</h2>
                <form method="post" action="password_reset_code.php">
                    ...
                    <div class="mb-5 d-flex justify-content-between align-items-center">
                        ...
                        ?>
                        <a class="link-opacity-75-hover" style="font-size: 0.88rem;" href="?action=register">Create New Account</a></p>
                        <button class="btn btn-outline-dark px-4 py-2" type="submit" name="password_reset_link">Send</button>
                    </div>
            ...
            <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb" class="px-4 py-2">
            <ol class="breadcrumb">
