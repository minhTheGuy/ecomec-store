...
if (Session::get("login") == false || Session::get("role") == "user") {
    header("Location: http://localhost/webapp/login/login.php");
}
?>
            ...
            <div class="row g-5 justify-content-center">
                <div class="col-lg-8 col px-4 py-2">
                    <form method="post" id="edit">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" placeholder="Leave a comment here" name="details" id="details" class="form-label" style="height: 100px" required></textarea>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="price" min="0" class="box" required max="9999999999" placeholder="enter product price" onkeypress="if(this.value.length == 10) return false;" name="price">
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="file" id="img_02" name="img_02">
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="file" id="img_03" name="img_03">
                                </div>
                            </div>
                        ...
                        <hr class="my-4">
                        <button type="submit" class="w-100 btn btn-primary btn-lg">Add Product</button>
                    </form>
                </div>
            </div>
        </main>
